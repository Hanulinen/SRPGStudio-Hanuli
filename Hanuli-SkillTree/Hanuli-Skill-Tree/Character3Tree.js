...
SkillTree.Character3 = defineObject(BaseSkillTree,
{
	unitId: 2, //Character id in the database
	...
	drawSkillTree: function(x, y) {	
		...
		var skillOrbImage = "orbgaubert"; 				//Skillorb file name with no index or filetype (assumed .png)
