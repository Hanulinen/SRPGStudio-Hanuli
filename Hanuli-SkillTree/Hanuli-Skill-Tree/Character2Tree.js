...
SkillTree.Character2 = defineObject(BaseSkillTree,
{
	unitId: 1, //Character id in the database
	...
	drawSkillTree: function(x, y) {	
		...
		var skillOrbImage = "orb"; 		//Skillorb file name with no index or filetype (assumed .png)
